...
/**
 * Converter for decode a string to a ReviewKey
 * 
...
public class ReviewKeyConverter implements Converter<String, ReviewKey>{
	...
	private static final Logger LOG = LoggerFactory.getLogger(ReviewKeyConverter.class);
	
	@Override
	public ReviewKey convert(String stringKey) {
		...
		ReviewKey compositeKey = new ReviewKey(stringKeys[0], Integer.parseInt(stringKeys[1]));
		return compositeKey;
	}
